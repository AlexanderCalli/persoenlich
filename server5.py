        ...
        try:
            ...
            while True:
                ...
                if "Which one is your novel? (Use arrow keys)" in line:
                    yield "data: WAITING_FOR_SELECTION\n\n"
                    break
...
def select_option():
    ...
    # Here you would typically use the search_id to find the correct generator
    # and send the option to it. For simplicity, we're not implementing this part.
